...
export const About = () => {
  return (
    <section id='about' className="dark:bg-secondary-400 md:mt-72 mt-32 md:pt-24 pt-12 relative pb-32 md:pb-64">
      <Image
        src="/images/glow.png"
        alt="glow"
        fill
        className="opacity-20  bg-yellow-500 w-full h-full absolute top-20 pointer-events-none"
      />
      <Container className="mt-24 z-20 relative">
        <div className="flex md:flex-row flex-col items-center">
          ...
          <div className="flex flex-col gap-y-10">
            <p className="md:text-2xl text-xl leading-normal text-gray-500 dark:text-gray-100 lg:w-3/4 w-full">
        ...
        <div className="flex justify-evenly">
          {stats.map((s) => (
            <div key={s.title} className="">
              ...
              <p className="md:text-2xl text-slate-900 dark:text-secondary-300 text-xl">{s.subtitle}</p>
            </div>
          ))}
        </div>
      </Container>
